  ...
  return (
    <div className='flex flex-col h-screen bg-gray-50'>
      ...
      <div className='flex justify-center items-center bg-white border-b border-gray-200 py-4 px-4 z-20'>
        <div className='flex gap-12'>
          <button
            ...
            className={`pb-2 font-semibold text-base transition-all relative ${
              activeTab === 'chats' ? 'text-purple-600' : 'text-gray-400'
            }`}
          >
            Chats
            {activeTab === 'chats' && (
          ...
          <button
            ...
            className={`pb-2 font-semibold text-base transition-all relative ${
              activeTab === 'calls' ? 'text-purple-600' : 'text-gray-400'
            }`}
          >
            Calls
            {activeTab === 'calls' && (
      ...
      <div className='flex flex-1 overflow-hidden'>
        {/* Sidebar - Chat List */}
        <div
          className={`w-full md:w-96 lg:w-[380px] bg-white border-r border-gray-200 flex flex-col ${
          ...
          <div className='flex-1 overflow-y-auto'>
            {conversations.map((conv, index) => (
              <div
                ...
                className={`flex items-center px-4 py-4 cursor-pointer border-b border-gray-100 transition-all ${
                  selectedChat === index ? 'bg-purple-50' : 'hover:bg-gray-50'
                }`}
              >
        ...
        <div
          className={`flex-1 flex flex-col bg-white ${
            !isMobileView && selectedChat === null ? 'hidden md:flex' : 'flex'
          }`}
        >
                ...
                <div className='flex items-center gap-3 relative'>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d='M28.0024 42.2641C35.8803 42.2641 42.2666 35.8778 42.2666 28C42.2666 20.1221 35.8803 13.7358 28.0024 13.7358C20.1246 13.7358 13.7383 20.1221 13.7383 28C13.7383 35.8778 20.1246 42.2641 28.0024 42.2641Z'
                        fill='#EDD9FF'
                        fill-opacity='0.5'
                      />
                      <path
                        d='M22.2968 30.8528C22.2968 30.8528 24.4364 33.7056 28.0024 33.7056C31.5685 33.7056 33.7081 30.8528 33.7081 30.8528'
                        fill='#EDD9FF'
                        fill-opacity='0.5'
                      />
                      <path
                        d='M22.2968 30.8528C22.2968 30.8528 24.4364 33.7056 28.0024 33.7056C31.5685 33.7056 33.7081 30.8528 33.7081 30.8528M23.7232 23.7207H23.7375M32.2817 23.7207H32.2959M42.2666 28C42.2666 35.8778 35.8803 42.2641 28.0024 42.2641C20.1246 42.2641 13.7383 35.8778 13.7383 28C13.7383 20.1221 20.1246 13.7358 28.0024 13.7358C35.8803 13.7358 42.2666 20.1221 42.2666 28Z'
                        stroke='black'
                        stroke-opacity='0.54'
                        stroke-width='2.5'
                    ...
                    <>
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <path
                            d='M28.0024 34.9853C30.8671 34.9853 33.1894 32.6726 33.1894 29.8197C33.1894 26.9668 30.8671 24.6541 28.0024 24.6541C25.1378 24.6541 22.8155 26.9668 22.8155 29.8197C22.8155 32.6726 25.1378 34.9853 28.0024 34.9853Z'
                            stroke='black'
                            stroke-opacity='0.54'
                            stroke-width='2.3'
                            stroke-linecap='round'
